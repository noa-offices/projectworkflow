  ...
  return (
    <DashboardCard className="p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-zinc-950">Local Workspace</p>
          <p className="mt-1 text-xs text-zinc-500">Local cache renders first, then Supabase sync refreshes in the background.</p>
        </div>
