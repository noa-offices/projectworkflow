...
const choices: Array<{ focus: ExtractionPromptFocus; label: string; description: string }> = [
  ...
  { focus: "accessories_electrification", label: "Accessories / Electrification", description: "Extract standalone and product-local accessories, cable management, electrification, modules, mounting requirements, compatibility and finish codes." },
];
...
const planningChoices: Array<{ focus: ProductTemplateSetupPlanningFocus; label: string; description: string }> = [
  ...
  { focus: "screens", label: "Screens / Dividers", description: "Plan desk, side, framed, acoustic, freestanding and floor screens, mounting systems, required companions and related accessories." },
...
export function CopyAiExtractionPrompt({ onFocusChange }: { onFocusChange?: (focus: ExtractionPromptFocus) => void } = {}) {
