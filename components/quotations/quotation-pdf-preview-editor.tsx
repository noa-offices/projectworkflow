        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              <div className="grid gap-2 rounded-lg border border-zinc-200 bg-zinc-50 p-3 md:col-span-2 xl:col-span-1">
              ...
              <div className="grid gap-2 rounded-lg border border-zinc-200 bg-zinc-50 p-3 md:col-span-2 xl:col-span-2">
              ...
              <div className="grid gap-2 rounded-lg border border-zinc-200 bg-zinc-50 p-3 md:col-span-2 xl:col-span-3">
              ...
              <div className="grid gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 md:col-span-2 xl:col-span-3">
            ...
            <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-3">
              ...
              <div className="mt-3 max-h-[420px] overflow-y-auto rounded-md border border-zinc-200 bg-white">
