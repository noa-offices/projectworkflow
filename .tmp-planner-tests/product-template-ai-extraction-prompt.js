...
exports.extractionPromptFocuses = void 0;
exports.getProductTemplateAiExtractionPrompt = getProductTemplateAiExtractionPrompt;
exports.extractionPromptFocuses = ["full", "base_model", "workstation", "category_matrix", "modular", "accessories", "product_details", "materials"];
...
function getProductTemplateAiExtractionPrompt(focus = "full") {
...
export function buildProductTemplateSetupPlanningPrompt() {
  return `;
    You;
    are;
    planning;
    ...
    only;
    relationships, page;
    ranges, products, prices, compatibility, and;
    requirements;
    supported;
    by;
    the;
    ...
    companions, accessory;
    applicability, or;
    pricing;
    structures.Distinguish;
    explicit;
    manufacturer;
    rules;
    from;
    your;
    recommendations / inferences.Label;
    uncertainty;
    DECISION.Use;
    actual;
    PDF;
    ...
    giant;
    template;
    for (fundamentally; unrelated; families, or)
        arbitrary;
    splits;
    based;
    only;
    ...
    separate;
    templates;
    for (distinct; typologies, leg / base; systems, commercial)
    ...
    desk / model;
    tables.Supports;
    groups, rows / models, price / currency, dimensions, specifications, visual;
    subgroups, and;
    reference;
    images.Quotation;
    flow;
    ...
    rows / items;
    remain;
    pricing - authoritative.Recommend;
    a;
    subgroup;
    only;
    where;
    ...
    a;
    manufacturer;
    diagram, shape / configuration, size;
    family, or;
    orientation;
    family.Image;
    levels: Group;
    ...
    Finish;
    Guidance;
    for (finish - code; tables, allowable; top / leg)
        finishes, or;
    colour;
    guidance;
    unless;
